...
function ProductTable({
  ...
  const rows: ReactElement<typeof ProductCategoryRow>[] = [];
  let lastCategory: (typeof PRODUCTS)[number]['category'] | null = null;
...
function FilterableProductTable({ products }: { products: typeof PRODUCTS }) {
